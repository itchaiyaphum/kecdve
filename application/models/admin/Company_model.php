...
class Company_model extends BaseModel
{
    ...
    {
        parent::__construct();
        $this->table = $this->ci->factory_lib->getTable('Company');
    }
    ...
    public function getItems($options = array())
    {
        ...
        $sql = "SELECT * FROM company WHERE {$where}";
    ...
    {
        $filter_search = $this->ci->input->get_post('company_filter_search');
        $filter_status = $this->ci->input->get_post('company_filter_status');
