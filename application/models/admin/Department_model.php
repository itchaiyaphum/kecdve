...
class Department_model extends BaseModel
{
    ...
    {
        parent::__construct();
        $this->table = $this->ci->factory_lib->getTable('Department');
    }
    ...
    public function getItems($options = array())
    {
        ...
        $sql = "SELECT * FROM department WHERE {$where}";
    ...
    {
        $filter_search = $this->ci->input->get_post('department_filter_search');
        $filter_status = $this->ci->input->get_post('department_filter_status');
