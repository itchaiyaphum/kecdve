...
<ul class="tm-nav uk-nav" data-uk-nav="">
	...
	<li class="<?php echo $this->helper_lib->getActiveMenu('activity');?>">
		<a href="<?php echo base_url('profile/advisor/activity/'); ?>"><span class="uk-icon-book"></span> บันทึกการเรียน</a>
	</li>
	<li class="<?php echo $this->helper_lib->getActiveMenu('time');?>">
		<a href="<?php echo base_url('profile/advisor/time/'); ?>"><span class="uk-icon-clock-o"></span> บันทึกเวลาเรียน</a>
	</li>
	<li class="<?php echo $this->helper_lib->getActiveMenu('evaluation');?>">
		<a href="<?php echo base_url('profile/advisor/evaluation/'); ?>"><span class="uk-icon-pie-chart"></span> ประเมินการฝึกงาน</a>
	</li>
</ul>
<br/><br/>