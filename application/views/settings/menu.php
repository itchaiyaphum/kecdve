...
<ul class="tm-nav uk-nav" data-uk-nav="">
	...
	<li class="<?php echo $this->helper_lib->getActiveMenu('profile');?>">
		<a href="<?php echo base_url('settings/profile'); ?>"><span class="uk-icon-home"></span> แก้ไขข้อมูล</a>
	</li>
	<li class="<?php echo $this->helper_lib->getActiveMenu('password');?>">
		<a href="<?php echo base_url('settings/password/'); ?>"><span class="uk-icon-book"></span> แก้ไขรหัสผ่าน</a>
	</li>
</ul>
<br/><br/>